        ...
        <footer className="mt-4 relative">
            <div className="relative py-4 text-center bg-background z-10">
                ...
                <div className="flex justify-center space-x-2">
                    <a href={process.env.NEXT_PUBLIC_FACEBOOK} className="text-foreground dark:text-gray-100 hover:text-gray-300 dark:hover:text-gray-500">
                        <FaFacebook className="h-6 w-6 rounded-full p-1 bg-white dark:bg-gray-700 shadow-lg" />
                    </a>
                    <a href={process.env.NEXT_PUBLIC_INSTAGRAM} className="text-foreground dark:text-gray-100 hover:text-gray-300 dark:hover:text-gray-500">
