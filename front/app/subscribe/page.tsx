...
export default async function Subscribe() {
    ...
    return (
        <section id="practical" className="w-full flex flex-col items-center gap-6">
            ...
            <a target="_blank" href={`/api/file?file=${encodedFileAttributes}`} className="w-fit bg-primary text-white font-bold py-2 px-4 rounded outline-none scale-100 hover:shadow-2xl hover:shadow-white hover:scale-110 transition-all duration-300" type="button" id="subscriptionButton">
