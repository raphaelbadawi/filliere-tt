...
export interface ApiContestContest extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    teamId: Schema.Attribute.Integer & Schema.Attribute.Required;
...
export interface ApiPostPost extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::post.post'> &
      Schema.Attribute.Private;
    picture: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    post_subscriptions: Schema.Attribute.Relation<
      'oneToMany',
      'api::post-subscription.post-subscription'
    >;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiPracticalPractical extends Struct.SingleTypeSchema {
...
export interface ApiTitleTitle extends Struct.SingleTypeSchema {
